...
public class MavenPomTest {
    ...
    public void test() throws Exception {
        ...
        String bundleId = "dkpro.opennlp.en:1.7.0";
        BundleDef bundle = new Controller().load().getBundleDef(bundleId);
        assertNotNull("bundle not found" + bundleId, bundle);
        ...
        assertTrue(pom.contains("<version>1.7.0</version>"));
