...
public class Obo2Wordtable {
    ...
    public static void main(String[] args) throws IOException {
        ...
        "GeneNames",//
                "hbp_developmental_ontology",//
                "hbp_layer_ontology", //
                "hbp_morphology_ontology", "hbp_neurotransmitter_ontology" }) {

            OBOOntology obo = new OBOOntology();
            obo.read(new File(DIR, oboFile + ".obo"));

            process(obo, oboFile);
        }

        for (String roboFile : new String[] {//
        "hbp_electrophysiology-triggers_ontology",
                "hbp_electrophysiology_ontology" }) {
            OBOOntology obo = RoboExpander.expand(new File(DIR, roboFile
                    + ".robo"));
            process(obo, roboFile);
        }
    }
    ...
    private static void process(OBOOntology obo, String oboFile)
        ...
        FileWriter wordtableWriter = new FileWriter(new File(DIR, oboFile
                + ".csv"));
