...
public class Booter
{
    ...
    {
        return new ArrayList<RemoteRepository>( Arrays.asList( newCentralRepository(), dkproCentralRepository() ) );
    }
    ...
    {
        return new RemoteRepository.Builder( "dkpro", "default", "http://zoidberg.ukp.informatik.tu-darmstadt.de/artifactory/public-model-releases-local/" ).build();
    }
